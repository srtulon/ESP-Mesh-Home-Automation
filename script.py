...
# Database connection
conn = mariadb.connect(host='192.168.1.49', database='test', password='abc123', user='root')
c = conn.cursor()
...
client.connect("192.168.1.49", 1883, 60)  # change the address to MQTT broker server
client.loop_forever()
